...
/obj/item/slimecross/stabilized/gold/attack_self(mob/user)
	var/choice = tgui_input_list(user, "Which do you want to reset?", "Familiar Adjustment", sortList(list("Familiar Location", "Familiar Species", "Familiar Sentience", "Familiar Name")))
